...
<!-- ✅ Script utama untuk add to cart dengan popup rekomendasi - FIXED VERSION -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addRecommendedToCart(menuId, menuName, menuPrice) {
        ...
        // ✅ FIXED: Tambahkan qty field yang hilang
    ...
    // ✅ Enhanced add to cart dengan popup rekomendasi untuk takeaway - FIXED VERSION
    document.querySelectorAll('.add-to-cart-btn').forEach(function(button) {
        button.addEventListener('click', function(e) {
            ...
            // ✅ FIXED: Tambahkan field qty yang hilang dalam AJAX request
            fetch('/takeaway/store', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                ...
                body: JSON.stringify({
                    menu_id: menuId,
                    qty: 1, // ✅ Field qty yang hilang - ini yang menyebabkan error
                    jenis_pesanan: 'takeaway',
                    nomor_wa: nomorWA
                })
            })
